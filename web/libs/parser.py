...
class Argument(object):
    ...
    def __init__(self, name, default=None, handler=None, required=True, type=str, filter=None, help=None,pattern=date_format,
                 nullable=False):
        self.name = name
    ...
    def parse(self, has_key, value):
        ...
        try:
            if self.type:
                ...
                #str 转换date
                elif self.type == datetime.date and isinstance(value, str):
                     value = datetime.datetime.strptime(value, self.pattern)
