(function() {
    ...
    function ba(a) {
        ...
        for (var c = -271733879, d = -1732584194, e = 271733878, f = 0; f < b.length; f += 16) {
            ...
            a = E(a, c, d, e, b[f + 1], 4, -1530992060);
            ...
            a = C(a, c, d, e, b[f + 0], 6, -198630844);
            e = C(e, a, c, d, b[f + 7], 10, 1126891415);
            d = C(d, e, a, c, b[f + 14], 15, -1416354905);
            c = C(c, d, e, a, b[f + 5], 21, -57434055);
            a = C(a, c, d, e, b[f + 12], 6, 1700485571);
            e = C(e, a, c, d, b[f + 3], 10, -1894986606);
            d = C(d, e, a, c, b[f + 10], 15, -1051523);
            c = C(c, d, e, a, b[f + 1], 21, -2054922799);
            a = C(a, c, d, e, b[f + 8], 6, 1873313359);
            e = C(e, a, c, d, b[f + 15], 10, -30611744);
            d = C(d, e, a, c, b[f + 6], 15, -1560198380);
            c = C(c, d, e, a, b[f + 13], 21, 1309151649);
            a = C(a, c, d, e, b[f + 4], 6, -145523070);
            e = C(e, a, c, d, b[f + 11], 10, -1120210379);
            d = C(d, e, a, c, b[f + 2], 15, 718787259);
            c = C(c, d, e, a, b[f + 9], 21, -343485551);
            a = A(a, g);
            c = A(c, p);
            d = A(d, h);
            e = A(e, m)
    ...
    for (var R = Ja, sa = Math, ta = R, S = ta.lib, xb = S.WordArray, ua = S.Hasher, S = ta.algo, db = [], eb = [], va = 2, ga = 0; 64 > ga; ) {
        var X;
        a: {
            X = va;
            for (var yb = sa.sqrt(X), La = 2; La <= yb; La++)
                if (!(X % La)) {
                    X = !1;
                    break a
                }
        ...
        X && (8 > ga && (db[ga] = Ya(sa.pow(va, .5))),
        eb[ga] = Ya(sa.pow(va, 1 / 3)),
        ga++);
        va++
    }
    var T = []
      , S = S.SHA256 = ua.extend({
        ...
        _doProcessBlock: function(a, b) {
            for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], g = c[3], p = c[4], h = c[5], m = c[6], L = c[7], k = 0; 64 > k; k++) {
                ...
                n = L + ((p << 26 | p >>> 6) ^ (p << 21 | p >>> 11) ^ (p << 7 | p >>> 25)) + (p & h ^ ~p & m) + eb[k] + T[k];
    ...
    var Y, J = r, q = u, O = h, gb = !1, oa = [function() {
        if (gb) {
    ...
    ], N = [], la = [], U = [], Z, na, Ea, Va, Q = !1, ma = !1, M, Aa, Sa = !0, m, Ab = "undefined" != typeof q.getElementById && "undefined" != typeof q.getElementsByTagName && "undefined" != typeof q.createElement, wa = O.userAgent.toLowerCase(), xa = O.platform.toLowerCase(), Bb = xa ? /win/.test(xa) : /win/.test(wa), Cb = xa ? /mac/.test(xa) : /mac/.test(wa), Db = /webkit/.test(wa) ? parseFloat(wa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ma = !+"\x0B1", ha = [0, 0, 0], I = null;
    ...
    m.w3 && (("undefined" != typeof q.readyState && "complete" == q.readyState || "undefined" == typeof q.readyState && (q.getElementsByTagName("body")[0] || q.body)) && V(),
    Q || ("undefined" != typeof q.addEventListener && q.addEventListener("DOMContentLoaded", V, !1),
    ...
    m.ie && m.win && r.attachEvent("onunload", function() {
        for (var a = U.length, b = 0; b < a; b++)
            U[b][0].detachEvent(U[b][1], U[b][2]);
        a = la.length;
        for (b = 0; b < a; b++)
            Ua(la[b]);
        for (var c in m)
    ...
    var hb = {
      ...
      , Fb = ["scrAvailWidth", "scrAvailHeight"];
    aa.prototype = {
    ...
    var ca = 8
      , Gb = ["sessionStorage", "localStorage", "indexedDb", "openDatabase"]
    ...
    try {
        ...
        t.evercookie = t.Evercookie = function(a) {
            ...
            this.evercookie_auth = function(a, c) {
                if (void 0 !== c) {
                    var d = "//" + c + "@" + sb.host + p + h + b.authPath + "?name\x3d" + a
                      , e = new ib;
                ...
                c.getDfpMoreInfo(function() {
                    if (!(9E5 < G("RAIL_EXPIRATION") - (new Date).getTime() & null != G("RAIL_DEVICEID") & void 0 != G("RAIL_DEVICEID") & !c.NeedUpdate())) {
                        for (var a = "", e = "", h = c.getpackStr(b), m = [], q = [], t = [], k = [], n = 0; n < h.length; n++)
                            "new" != h[n].value && -1 == Hb.indexOf(h[n].key) && (-1 != Gb.indexOf(h[n].key) ? q.push(h[n]) : -1 != Fb.indexOf(h[n].key) ? t.push(h[n]) : -1 != Eb.indexOf(h[n].key) ? k.push(h[n]) : m.push(h[n]));
                        h = "";
                        ...
                        $a.getJSON("https://kyfw.12306.cn/otn/HttpZF/logdevice" + ("?algID\x3dJI0lAthBpv\x26hashCode\x3d" + e + a), null, function(a) {
                            var b = JSON.parse(a);
