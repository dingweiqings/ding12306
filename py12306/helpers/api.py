...
API_PASSENGER_QUERY=BASE_URL_OF_12306+'/otn/passengers/query'

API_QUERY_PRICE=BASE_URL_OF_12306+'/otn/leftTicket/queryTicketPrice'
API_QUERY_PRICE_FL=BASE_URL_OF_12306+'/otn/leftTicket/queryTicketPriceFL'
API_TICKET_INDEX=BASE_URL_OF_12306 +'/index'
